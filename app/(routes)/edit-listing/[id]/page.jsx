              ...
              <div className="p-8 rounded-lg shadow-md">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <Input type="number" placeholder="Ex.1900 Sq.ft" name="lotSize" onChange={handleChange} />
                  </div>
                  <div className="flex flex-col gap-2">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <Input type="number" placeholder="400000 Sq.ft" name="price" onChange={handleChange} />
                  </div>
                  <div className="flex flex-col gap-2">
                ...
                <div className="grid grid-cols-1 gap-10">
                  <div className="flex flex-col gap-2">
                    ...
                    <Textarea type="number" placeholder="" name="description" onChange={handleChange} />
                  </div>
                </div>
